Alias: StrengthOfRecommendationExtension = http://hl7.org/fhir/StructureDefinition/cqf-strengthOfRecommendation
Alias: DirectionOfRecommendationExtension = http://hl7.org/fhir/uv/cpg/StructureDefinition/cpg-directionOfRecommendation
Alias: QualityOfEvidenceExtension = http://hl7.org/fhir/StructureDefinition/cqf-qualityOfEvidence
...
* action.documentation.extension contains StrengthOfRecommendationExtension named strengthOfRecommendation 0..1 MS
* action.documentation.extension contains DirectionOfRecommendationExtension named directionOfRecommendation 0..1 MS 
* action.documentation.extension contains QualityOfEvidenceExtension named qualityOfEvidence 0..1 MS 
